  ...
  <div class="body-container">
    ...
    <div class="hero__title" v-show="address !== null">
      <div class="hero__title-ks">
        ...
        <div class="hero__title" v-show="transactionHash === null && sending !== null">
      Executed!
      <div class="hero__subTitle2" v-show="transactionHash === null && sending !== null">
        Transaction Hash ID is:
      </div>
      <div class="hero__subTitle3" v-show="transactionHash === null && sending !== null">
        {{ sending }}
      </div>
    </div>
